...
%% Directories
    ...
    % Tethsy
    dir_ROMS   = '/data/project6/friederc/macmods_input/SBC_farm/SBCfarm_';
    dir_WAVE   = '/data/project6/friederc/macmods_input/SBC_farm/';
    dir_LES    = '/data/project6/friederc/macmods_input/LES_data/';
    dir_OUTPUT = '/data/project6/friederc/macmods_output/';
    % HPC
...
%    dir_OUTPUT = '/dfs7/dfs2/davis/friederc/hpc3_output/';
    % Local
%     dir_ROMS   = 'D:\Data\SBC_Farm\SBCfarm_';
%     dir_WAVE   = 'D:\Data\SBC_Farm\';
%     dir_LES    = 'D:\LES_sim\LES_data\';
%     dir_ROMS   = 'C:\Users\Christinaf\OneDrive - SCCWRP\macmods\hpc_sim\mag_v18_hpc3\SBC_farm\SBCfarm_';
%     dir_WAVE   = 'C:\Users\Christinaf\OneDrive - SCCWRP\macmods\hpc_sim\mag_v18_hpc3\SBC_farm\';
%     dir_LES    = 'C:\Users\Christinaf\OneDrive - SCCWRP\macmods\hpc_sim\mag_v18_hpc3\LES_data\';
...
for year = 2001
    ...
    % NetCDF -> save variables: frond ID, location, time, Btot, Bcan
        ...
        file_date = sprintf('MAG_18_01_l.nc');
        output_filename1  = strcat(dir_OUTPUT,file_date); clear file_date
        %file_date = sprintf('MAG_18_01_l_fronds.nc');
...
for growth_step = time.dt_Gr:time.dt_Gr:time.duration
    ...
    ROMS_step = ceil(Gr_step*time.dt_Gr/time.dt_ROMS); % ROMS counter
        ...
        if Gr_step == 99 % explore doy 99
           output_workspace = strcat(dir_OUTPUT,'MAG_18_01_l_DOY99.mat');
    ...
    output_notes = strcat(dir_OUTPUT,'MAG_18_01_l_output.mat');
